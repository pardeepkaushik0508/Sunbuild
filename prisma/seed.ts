...
const SUNVIEW_PROJECTS: SeedProjectDef[] = [
  {
    name: "Clearwater Park, Chestermere",
    lotInfo: "Clearwater Park — Chestermere (Now Selling)",
    municipalAddress: "Clearwater Park, Chestermere, AB",
  ...
  {
    name: "Waterford, Chestermere",
    lotInfo: "Waterford — Chestermere (Now Selling)",
    municipalAddress: "Waterford, Chestermere, AB",
    status: ProjectStatus.IN_PROGRESS,
    progressPercent: 61,
  ...
  {
    name: "Southshore, Chestermere Lake",
    lotInfo: "Southshore — Chestermere Lake (Now Selling)",
    municipalAddress: "Southshore, Chestermere Lake, AB",
  ...
  {
    name: "Edgefield Phase 3, Strathmore",
    lotInfo: "Edgefield Phase 3 — Strathmore (Now Selling)",
    municipalAddress: "Edgefield Phase 3, Strathmore, AB",
  ...
  {
    name: "The Ranch, Strathmore",
    lotInfo: "The Ranch — Strathmore (Sold Out community reference)",
    municipalAddress: "The Ranch, Strathmore, AB",
    status: ProjectStatus.IN_PROGRESS,
    progressPercent: 35,
...
async function seedProjectContent(opts: {
  ...
  await prisma.photo.createMany({
    data: [
      {
        projectId,
        // Served from /public (no /api/files) — works on Render without local disk.
        filePath: "/placeholders/site-progress.svg",
        fileName: `site-progress-${n}.svg`,
