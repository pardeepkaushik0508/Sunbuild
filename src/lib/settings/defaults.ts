...
export const DEFAULT_TWILIO: TwilioIntegrationSettings = {
  ...
  trialReady: null,
  statusCallbackUrl: "/api/twilio/sms/status",
  inboundWebhookUrl: "/api/twilio/inbound",
  smsStatusCallbackUrl: "/api/twilio/sms/status",
  whatsappStatusCallbackUrl: "/api/twilio/whatsapp/status",
  whatsappIncomingWebhookUrl: "/api/twilio/whatsapp/incoming",
  whatsappConfigured: false,
  whatsappFromDisplay: null,
  whatsappMode: "not_configured",
  recentFailures: [],
  diagnostics: [],
};
